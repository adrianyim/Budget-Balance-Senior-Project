"""
Django settings for budgetGuardian project.
...
SECRET_KEY = 'p#zmd5angk^hth!gwrw_nao-6+p1aeqy9eic_!-v%@vj+5xmrq'
...
ROOT_URLCONF = 'budgetGuardian.urls'
...
WSGI_APPLICATION = 'budgetGuardian.wsgi.application'
